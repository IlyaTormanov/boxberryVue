<template>
    <div id="calculator">
        ...
        <div class="calculator-options calculator-options_service">
            ...
            <div>
                <Checkbox v-for="item in checkBoxData"
                          v-model="item.value"
                          :name="item.name"
                          :label="item.label"
                          unique="+25₽"
        ...
        <div class="calculator_nav">
            <div class="calculator_nav_inner">
                ...
                <Button text="Расчитать" :on-click="()=>{}" />
            </div>
        </div>
    </div>
                ...
                checkBoxData: [
                    {
                        name: "gift",
                        value: false,
                        label: "Голосовое оповещение отправителя о выдаче посылки"
                    },
                    {
                        name: "send",
                        value: false,
                        label: "Голосовое оповещение получателя о поступлении посылки"
                    }
                ],
                focus: false,
                currentFrom: [],
